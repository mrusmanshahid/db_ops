...
## Background
The project is focused on handy scripts tasks arround multiple daily challenges for any database engineer.
## List of Scripts
...
- [Split schemas using MySQL native replication or using AWS-DMS](https://github.com/mrusmanshahid/db_ops/tree/main/schema-splitter#custom-for-mysql-cluster)